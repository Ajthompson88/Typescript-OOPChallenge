...
export function loadVehicles(): (Car | Truck | Motorbike)[] {
...
export function saveVehicles(vehicles: (Car | Truck | Motorbike)[]): void {
...
export function writeResponseToFile(response: string): void {
