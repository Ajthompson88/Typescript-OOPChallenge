...
class Cli {
    ...
    inquirer
      ...
      .then((answers) => {
        const motorbike = new Motorbike(
          ...
          parseInt(answers.topSpeed),
          [
            new Wheel(parseInt(answers.frontWheelDiameter)),
            new Wheel(parseInt(answers.rearWheelDiameter)),
          ]
        );
  ...
  findVehicleToTow(truck: Truck): Promise<void> {
    // Implementation of findVehicleToTow
          ...
          case 'Tow vehicle':
            if (selectedVehicle instanceof Truck) {
              this.findVehicleToTow(selectedVehicle).then(() => {
                // Avoid instantly calling performActions again
              });
              return;
            } else {
